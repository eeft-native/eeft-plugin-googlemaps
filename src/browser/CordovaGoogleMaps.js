...
var PluginMap = require('eeft-plugin-googlemaps.PluginMap'),
  PluginStreetViewPanorama = require('eeft-plugin-googlemaps.PluginStreetViewPanorama'),
  event = require('eeft-plugin-googlemaps.event'),
  Environment = require('eeft-plugin-googlemaps.PluginEnvironment');
