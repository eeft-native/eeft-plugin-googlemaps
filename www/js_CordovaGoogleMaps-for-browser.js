...
if (!window.Promise) {
  window.Promise = require('eeft-plugin-googlemaps.Promise');
}

var common = require('eeft-plugin-googlemaps.Common'),
  Map = require('eeft-plugin-googlemaps.Map'),
  StreetViewPanorama = require('eeft-plugin-googlemaps.StreetViewPanorama');
